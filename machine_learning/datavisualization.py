...
#mi aspetto che initial_time_in_fill sia un vettore con 99 elementi

#A DIVERSI FILL CORRISPONDONO DIVERSI time_in_fill INIZIALI !!!
#l'unico modo per rendere uguali tutti i tempi iniziali è normalizzare ogni fill
